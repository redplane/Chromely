...
{
    public class DynamicCefBinariesLoader : IDynamicCefBinariesLoader
    {
        #region Properties
        ...
        public DynamicCefBinariesLoader(IServiceProvider serviceProvider)
        {
        ...
        public List<string> Load(IChromelyConfiguration config)
        {
            var dynamicCefLoader = _serviceProvider.GetService<IDynamicCefLoader>();
            try
            {
                var platform = CefRuntime.Platform;
                var version = CefRuntime.ChromeVersion;
                _logger?.LogInformation($"Running {platform} chromium {version}");
                ...
                catch (Exception ex)
                {
                    ...
                    if (config.CefDownloadOptions.AutoDownloadWhenMissing)
                    {
                        ...
                        {
                            dynamicCefLoader.Download(config.Platform);
                            dynamicCefLoader.SetMacOSAppName(config);
                        }
                        else
                        {
        ...
        /// The temp files.
        /// </param>
        public void DeleteTempFiles(List<string> tempFiles)
        {
        ...
        /// </returns>
        private List<string> DownloadAndNotifyUser(ChromelyPlatform platform)
        {
            ...
            try
            {
                ...
                dynamicCefLoader.Download(platform);
        ...
        /// </returns>
        protected virtual string ShowDownloadStartedPage()
        {
        ...
        /// The temporary file created.
        /// </returns>
        protected virtual string ShowDownloadCompletedPage(string durationInfo)
        {
            var message = new Tuple<string, string, string>(
        ...
        /// The temporary file created.
        /// </returns>
        protected virtual string ShowErrorPage(Exception ex)
        {
            var message = new Tuple<string, string, string>(
        ...
        /// The temporary file created.
        /// </returns>
        protected virtual string ShowPageWithCustomMessage(Tuple<string, string, string> message)
        {
            try
            {
